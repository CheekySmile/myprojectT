...
class TestElements:
    ...
    class TestDynamicPropertiesPage:
        def test_click_button(self, driver):
            click_button_page = DynamicPropertiesPage(driver, 'https://demoqa.com/dynamic-properties')
            click_button_page.open()
            click = click_button_page.check_click_change()
            assert click is True, "button did not enable after 5 second"
        ...
        def test_appear_button(self, driver):
            appear_button_page = DynamicPropertiesPage(driver, 'https://demoqa.com/dynamic-properties')
            appear_button_page.open()
            appear = appear_button_page.check_appear_button()
